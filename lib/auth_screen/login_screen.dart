...
import 'package:testpro/auth_screen/signup_screen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Lottie.asset('assets/images/login.json', height: 200), // Use a login Lottie animation
                  ...
                  child: Column(
                    children: [
                      ...
                      if (errorMessage != null)
                        Text(
                          errorMessage!,
                          style: const TextStyle(color: AppTheme.redColor, fontSize: 14),
                        ),
